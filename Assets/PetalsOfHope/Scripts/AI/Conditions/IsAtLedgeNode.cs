...
namespace PetalsOfHope.AI
{
    ...
    public class IsAtLedgeNode : ConditionNode
    {
        ...
        protected override NodeState OnUpdate(AIContext context)
        {
            ...
            Vector2 boxCenter = (Vector2)context.AgentTransform.position + new Vector2(context.PatrolData.ledgeCheckBoxOffset.x * context.PatrolDirection, context.PatrolData.ledgeCheckBoxOffset.y);
